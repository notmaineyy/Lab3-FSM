...
void Vlfsr_challenge___024root__trace_chg_sub_0(Vlfsr_challenge___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vlfsr_challenge___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlfsr_challenge___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vlfsr_challenge___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vlfsr_challenge___024root__trace_chg_sub_0(Vlfsr_challenge___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vlfsr_challenge__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlfsr_challenge___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgCData(oldp+4,(vlSelf->lfsr_challenge__DOT__sreg),7);
}

void Vlfsr_challenge___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlfsr_challenge___024root__trace_cleanup\n"); );
    // Init
    Vlfsr_challenge___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vlfsr_challenge___024root*>(voidSelf);
    Vlfsr_challenge__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
